...
**Disclaimer:**  
* This information is for general guidance. Always refer to the [official Google AI Studio documentation](https://ai.google.dev/gemini-api/docs/api-key) for the most up-to-date and accurate instructions.
